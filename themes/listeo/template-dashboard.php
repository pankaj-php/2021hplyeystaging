		...
		<div class="dashboard-nav-inner">
			...
			<ul data-submenu-title="<?php esc_html_e('Main','listeo');?>">
				...
				<?php if(in_array($role,array('administrator','admin','owner'))) : ?>
					...
					<li <?php if( $post->ID == $bookings_page ) : ?>class="active" <?php endif; ?>><a><i class="fa fa-calendar-check-o"></i> <?php esc_html_e('Bookings','listeo');?></a>
						<ul>
							<li>
		...
		<div id="titlebar">
			<div class="row">
				<div class="col-md-12">
					...
					<nav id="breadcrumbs">
						<ul>
							<li><a href="#"><?php esc_html_e('Home','listeo'); ?></a></li>
