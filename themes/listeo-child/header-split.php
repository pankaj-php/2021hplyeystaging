...
{
 setTimeout(function(){
	jQuery(".vc_row-fluid .listing-item-container, section.fullwidth .listing-item-container, .fs-content .listing-item-container").css("border","1px solid rgba(34,36,38,.1)");
	jQuery(".listeo-featured-listing-box").css("display","block");
	jQuery("img.listeo_liting_single_galary_image").css("display","block");
}, 500);
});
</script>
<style>
img.listeo_liting_single_galary_image {
    display: none;
}
