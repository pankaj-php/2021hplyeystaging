							...
							<?php if(get_option('listeo_profile_allow_role_change')): ?>
								<?php if(in_array($role, array('owner','guest'))): ?>
									...
									<select name="role" id="role">
										<option <?php selected($role,'guest'); ?> value="guest"><?php esc_html_e('User','listeo_core') ?></option>
										<option <?php selected($role,'owner'); ?> value="owner"><?php esc_html_e('Vendor','listeo_core') ?></option>
									</select>
								<?php endif; ?>
							<?php endif; ?>
