<div class="edit-form-field" style="display:none;">
    <div id="listeo-field-<?php echo $field_key; ?>">
        ...
        <?php if(in_array($field['name'], array('listing_type'))) { ?>
            <input  class="field-type-selector" type="text" name="type[<?php echo esc_attr( $index ); ?>]" value="select">
        <?php } ?> 
    ...
    <?php $multi = false ; ?>    
       <!--  <p class="multi-container">
        ...
        <p class="css-class-container">
            ...
            <input name="css_class[<?php echo esc_attr( $index ); ?>]"  type="text" value="<?php if(isset( $field['class'])) { echo esc_attr( $field['class'] ); }?>">
        </p>
