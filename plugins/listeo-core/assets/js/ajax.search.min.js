...
(function($){
	...
	$(document).ready(function(){
		...
		jQuery('.col-fs-6.input-with-icon.location a').on('click', function() {
		...
		$( '#listeo-listings-container' ).on( 'update_results', function ( event, page, append, loading_previous ) {
			...
			var interval = setInterval(function () {
			 $('.loader-ajax-container').html('<span class="counter">'+ ++counter +'</span> <div class="loader-ajax"></div>');
			}, 1000);*/
		...
		jQuery('body').on('change', '#listeo_core-search-form.ajax-search select, .sort-by-select .orderby, #listeo_core-search-form input:not(#keyword_search, #location_search, #_price_range, .bootstrap-range-slider)', function(e){
			var selected_tag=$(this).val();
			var selected_tag_upper=selected_tag.replace("-", " ");
		...
		//#listeo_core-search-form:not(.main-search-form) #keyword_search,
		// $(document).on( 'change', '.sort-by-select .orderby, #listeo_core-search-form.ajax-search select, .ajax-search input:not(#keyword_search,#location_search, #_price_range,.bootstrap-range-slider)', function(e) {
		// 	var selected_tag=$(this).val();
		// 	var selected_tag_upper=selected_tag.replace("-", " ");
